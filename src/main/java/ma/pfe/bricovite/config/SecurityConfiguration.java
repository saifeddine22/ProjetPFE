...
import ma.pfe.bricovite.security.*;
import ma.pfe.bricovite.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/commune").authenticated()
            .antMatchers("/api/commentaires").authenticated()
            ...
            .antMatchers("/politique-de-confidentialite").permitAll()
