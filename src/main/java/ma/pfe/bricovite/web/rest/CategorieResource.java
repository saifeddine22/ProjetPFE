...
/**
 * REST controller for managing {@link ma.pfe.bricovite.domain.Categorie}.
 */
@RestController
@RequestMapping("/api")
public class CategorieResource {
    ...
    public ResponseEntity<List<Categorie>> getAllCategories(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
