...
describe('Photo Management Component', () => {
  let comp: PhotoModalComponent;
  let fixture: ComponentFixture<PhotoModalComponent>;
  let service: PhotoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'photo', component: PhotoModalComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PhotoModalComponent, '')
      .compileComponents();
